...
function displayResultsTable(results) {
  ...
  // هدر جدول
  console.log('\n┌──────────┬────────────┬───────┬─────────────┬─────────────┬────────────┬────────────┬────────────┬────────────┬────────┐');
  console.log('│ Endpoint │ درخواست‌ها  │ خطاها │ درصد موفقیت │ زمان متوسط  │ سریع‌ترین   │ کندترین    │ P95        │ P99        │ وضعیت  │');
  console.log('├──────────┼────────────┼───────┼─────────────┼─────────────┼────────────┼────────────┼────────────┼────────────┼────────┤');
  ...
  results.forEach(result => {
    ...
    const successRate = result.successRate.padEnd(11);
    const avgTime = result.avgTime.padEnd(11);
    const minTime = result.minTime.padEnd(10);
    const maxTime = result.maxTime.padEnd(10);
    const p95Time = result.p95Time.padEnd(10);
    const p99Time = result.p99Time.padEnd(10);
